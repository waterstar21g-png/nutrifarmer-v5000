...
다음은 **한 번 반영하면 V5000·V6000 모두**에 적용되는 영역이다.
...
- V6000의 `lib/`, `app/api/`는 V5000에서 **복사본**이다.
- 통합 수용 시 **양쪽 저장소**에 반영하거나, 한쪽 수정 후 다른 쪽에 동일 패치를 적용한다.
- UI 전용 변경은 **해당 repo만** 수정한다.
...
| 문서 | V5000 | V6000 |
|------|--------|--------|
| 플랫폼 spec | `V5000-native-platform-spec.md` | `V6000-mobile-spec.md` |
| 버전 | `V5000-VERSION.json` | `V6000-VERSION.json` |
| SR | `docs/일별_사용자요건/SR_doc_*.md` | 동일 규칙, V6000 repo |
| CHANGELOG | `docs/CHANGELOG.md` (V5000) | V6000 major는 V6000-VERSION + SR |
